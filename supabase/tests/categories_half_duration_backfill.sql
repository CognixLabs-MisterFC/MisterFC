...
insert into public.categories (id, club_id, name, half_duration_minutes) values
  ('22222222-2222-4222-8222-222222229001', '11111111-1111-4111-8111-111111119001', 'Querubín', 15),
  ('22222222-2222-4222-8222-222222229002', '11111111-1111-4111-8111-111111119001', 'Prebenjamín A', 20),
  ('22222222-2222-4222-8222-222222229003', '11111111-1111-4111-8111-111111119001', 'Prebenjamin B', 20),
  ('22222222-2222-4222-8222-222222229004', '11111111-1111-4111-8111-111111119001', 'BENJAMÍN', 25),
  ('22222222-2222-4222-8222-222222229005', '11111111-1111-4111-8111-111111119001', 'Alevín 2', 30),
  ('22222222-2222-4222-8222-222222229006', '11111111-1111-4111-8111-111111119001', 'infantil', 35),
  ('22222222-2222-4222-8222-222222229007', '11111111-1111-4111-8111-111111119001', 'Cadete A', 40),
  ('22222222-2222-4222-8222-222222229008', '11111111-1111-4111-8111-111111119001', 'Juvenil', 45),
  ('22222222-2222-4222-8222-222222229009', '11111111-1111-4111-8111-111111119001', 'Amateur', 45),
  ('22222222-2222-4222-8222-22222222900a', '11111111-1111-4111-8111-111111119001', 'Veterano', 45),
  ('22222222-2222-4222-8222-22222222900b', '11111111-1111-4111-8111-111111119001', 'XYZ NoMatch', 45);
...
begin
  begin
    insert into public.categories (club_id, name, half_duration_minutes) values
  ('11111111-1111-4111-8111-111111119001', 'Bad Zero', 0);
...
begin
  begin
    insert into public.categories (club_id, name, half_duration_minutes) values
  ('11111111-1111-4111-8111-111111119001', 'Bad Huge', 91);
  exception when check_violation then
    ok := true;
  end;
  if not ok then
