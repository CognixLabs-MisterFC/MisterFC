...
/**
 * Búsqueda de Familias (insensible a acentos: el filtrado real es server-side con
 * foldForSearch). Escribe `q` en la URL con debounce y RESETEA `page` a 1 (una nueva
 * búsqueda empieza por la primera página). Preserva `segment` y `bajas`.
 */
export function FamiliesSearch() {
  const t = useTranslations('miembros.familias');
